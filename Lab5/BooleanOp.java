...
public class BooleanOp{
	public static void main(String[] args) {
		...
		Scanner in = new Scanner(System.in);// Moved this to the top.
		
		int a = 0, b = 0 , c = 0;
	
		System.out.println('A' + " is character");// I do not understand the purpose of this line
        ...
        c = in.nextInt();// I added this line
