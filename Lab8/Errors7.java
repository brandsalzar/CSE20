...
public class Errors7 {
	...
	public static void main(String[] args) {
		...
		n2 = input.nextInt();//Changed n1 to n2

		System.out.print("Please enter 3 number:");
		n3 = input.nextInt();//Changed n1 to n3

		System.out.print("Please enter 4 number:");
		n4 = input.nextInt();//Changed n1 to n4
		...
		if (n0 > 0)
			         ...
			         count = 1;
		if (n1 > 0)
		             total = total + n1;// added total
		    	     count = 2; //Changed 1 to 2
		                
	    if (n2 > 0) 
		             total = total + n2;
			         count = 3; //Changed 1 to 3
	    if (n3 > 0) 
	                 total = total + n3;
		             count += 1;
		if (n4 > 0)                
